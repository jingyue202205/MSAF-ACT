...
This repo contains the implementation of MSAF-ACT, together with 2 simulated environments:
Transfer Cube and Bimanual Insertion. You can train and evaluate MSAF-ACT in sim.
...
### references
our code is modified based on the [ACT code](https://github.com/tonyzhaozh/act.git). thanks a lot